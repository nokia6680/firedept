const tab = function () {
    let tabNav = document.querySelectorAll('.itemcard__nav-item'), // Выбираем элементы навигации табов
        tabContent = document.querySelectorAll('.itemcard__content-item'), // Выбираем самы табы
