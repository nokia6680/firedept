...
var sandwichToggle = function sandwichToggle() {
  ...
  var sandwichElements = document.querySelectorAll('.nav__toggle'); // Проходим циклом по всем эдементам и на каждый элемент вешаем слушателя, который по клику будет переключать класс
  ...
  function showSandwichTarget() {
    ...
    var navMenu = document.querySelector('.nav__wrap');
...
var details = document.querySelectorAll(".cat-popup__item"); // Add onclick listeners
...
var filterOpener = document.querySelector('.open-filter');
var filterBody = document.querySelector('.filter');
var filterCloser = document.querySelector('.js-filter-closer');
